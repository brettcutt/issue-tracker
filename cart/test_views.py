...
class TestViews(TestCase):
    ...
    def test_add_new_feature_to_cart(self):
        self.feature2 = Features.objects.create(name='new feature',
                                                description='this is a description',
                                                username=self.user,
                                                picture=self.pic)
        self.feature2.save()
